...
[while true;do date>>/data/date.txt;sleep 5;done](deployment.yaml).

3. Обеспечить возможность чтения файла контейнером multitool.

Ответ: Был создан общий том [volume-01](deployment.yaml), и подмонтирован в оба контейнера.
...
Ответ: Был создан том [volume-01](deployment-ds.yaml) типа **hostPath** и подмонтирован в контейнер.
